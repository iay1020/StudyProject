...
void SetMonster(_tagMonster* pMonsterArr)
{
	...
	/*
	pMonsterArr[0] = CreateMonster("고블린", 20, 30, 2, 5, 100,
		10, 1, 1000, 500, 1500);
	pMonsterArr[1] = CreateMonster("트롤", 80, 130, 60, 90, 2000,
...
void Battle(_tagPlayer* pPlayer, _tagMonster* pMonster)
{
	...
	cout << pPlayer->strName << " 가 " << pPlayer->strName <<
		"에게 " << iDamage << " 피해를 입혔습니다." << endl;
